 ...
 * @author tuan
 */
public class WikiRevisionRecordReader extends RecordReader<LongWritable, WikiRevisionWritable> {

	public static final byte[] START_TEXT = "<text xml:space=\"preserve\">".getBytes(StandardCharsets.UTF_8);
	public static final byte[] END_TEXT = "</text>".getBytes(StandardCharsets.UTF_8);
	
	public static final byte[] START_PARENT_ID = "<text xml:space=\"preserve\">".getBytes(StandardCharsets.UTF_8);
	...
	// 12 - just passed the <text> tag
	// 13 - just passed the </text> tag
	// 7 - just passed the </revision>
	// 8 - just passed the </page>
	private byte flag;
