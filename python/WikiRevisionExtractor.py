...
"""Wikipedia Revision Extractor - Adaptation of WikiExtractor in Wikipedia Revision
...
def load_entities():
    idset = set()
    with open('/home/tuan/Research/CIKM15-EntityLinking/tmp/entities.id','r') as f:
        for line in f:
            idset.add(int(line.rstrip()))
    return idset
