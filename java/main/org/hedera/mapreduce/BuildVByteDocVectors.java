...
/* 
 * Build standard vectors. Adapting from ClueWeb tool with FullRevision obj
 * 
...
public class BuildVByteDocVectors extends JobConfig implements Tool {
	...
	Mapper<LongWritable, FullRevision, LongWritable, BytesWritable> {
	...
	public int run(String[] args) throws Exception {
		...
		Job job = create(BuildVByteDocVectors.class.getSimpleName() + ":" + input, 
				BuildVByteDocVectors.class);
