...
public class WikiRevisionPageInputFormat1 extends
WikiRevisionInputFormat<WikipediaRevision> {

	@Override
	public RecordReader<LongWritable, WikipediaRevision> createRecordReader(
